          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="pt-2 flex gap-3">
                ...
                <a href="https://www.avito.ru/brands/73ec706323e74f732822382049cd02e0/all?sellerId=0b0c8ecd0e1307d79be53fc305f2abb0" target="_blank" rel="noopener noreferrer" className="text-[var(--white)] hover:text-[var(--ash)] transition-colors text-sm" title="Avito">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
