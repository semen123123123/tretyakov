    ...
    <footer id="footer" className="bg-[var(--ink)] text-[var(--white)] py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12">
          {/* Logo */}
          <div>
            <h3 className="font-display text-3xl font-bold mb-4">ТРЕТЬЯКОВ</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-[var(--white)]">+7 (999) 000-00-00</li>
              <li className="text-[var(--white)]">info@tretyakov.ru</li>
          ...
          {/* Social */}
          <div>
            <p className="system-label text-[var(--ash)] mb-4">СОЦИАЛЬНЫЕ СЕТИ</p>
            <div className="flex gap-4">
              <a href="#" className="text-[var(--white)] hover:text-[var(--ash)] transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[var(--ash)] text-sm">
            © 2024 ТРЕТЬЯКОВ. Все права защищены.
          </p>
